                ...
                <div className="font-Gill">
                    <div className="">
                        ...
                        <button onClick={() => handleFavorite(store._doc.id)}>
                            <svg fill={isFavorite(store._doc.id)} height="32px" width="32px" stroke={isFavorite(store._doc.id)} stroke-width={isFavoriteStroke(store._doc.id)}
